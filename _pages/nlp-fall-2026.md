    ...
    <div class="course-table-wrap">
      <table class="course-schedule">
        ...
        <tbody>
          ...
          <tr><td>Fri., Sept. 11</td><td><strong>Sequence labeling: POS tagging and NER</strong></td><td><a class="course-tag course-tag--reading" href="https://web.stanford.edu/~jurafsky/slp3/18.pdf" target="_blank" rel="noopener">SLP C18 (§§18.1–18.3, 18.6)</a> <a class="course-tag course-tag--reading" href="https://web.stanford.edu/~jurafsky/slp3/18.pdf#page=8" target="_blank" rel="noopener">Optional: §§18.4–18.5</a></td><td>—</td></tr>
          <tr class="course-week-start"><td rowspan="3"><strong>4</strong><small>Syntax and parsing</small></td><td>Mon., Sept. 14</td><td><strong>Constituency and context-free grammars</strong></td><td><a class="course-tag course-tag--reading" href="https://web.stanford.edu/~jurafsky/slp3/19.pdf" target="_blank" rel="noopener">SLP C19</a></td><td rowspan="3">{% if page.hw1_url != "" %}<a href="{{ page.hw1_url }}" target="_blank" rel="noopener"><strong>Homework 1</strong></a>{% else %}<strong>Homework 1</strong>{% endif %}<small>Due Sept. 18</small></td></tr>
          <tr><td>Wed., Sept. 16</td><td><strong>Probabilistic context-free grammars</strong></td><td>—</td></tr>
          <tr><td>Fri., Sept. 18</td><td><strong>CKY parsing</strong></td><td>—</td></tr>
