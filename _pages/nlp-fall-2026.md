    ...
    <div class="course-table-wrap">
      <table class="course-schedule">
        ...
        <tbody>
          ...
          <tr class="course-week-start"><td rowspan="3"><strong>4</strong><small>Syntax and parsing</small></td><td>Mon., Sept. 14</td><td><strong>Constituency and context-free grammars</strong></td><td><a class="course-tag course-tag--reading" href="https://web.stanford.edu/~jurafsky/slp3/19.pdf" target="_blank" rel="noopener">SLP C19</a></td><td rowspan="3">{% if page.hw1_url != "" %}<a href="{{ page.hw1_url }}" target="_blank" rel="noopener"><strong>Homework 1</strong></a>{% else %}<strong>Homework 1</strong>{% endif %}</td></tr>
