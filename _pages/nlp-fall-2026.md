...
w2d12_slides_url: "https://docs.google.com/presentation/d/1SP3gUsdDbn7Tfk4sJUz0zkdULKu60pDgoh3eEi-mxFY/edit?usp=sharing"
...
w5d1_slides_url: "https://drive.google.com/file/d/10jMtzC_hScc9X8XobfAGQVgmX9831C4g/view?usp=sharing"
w5d1_notebook_url: "https://colab.research.google.com/drive/1tJsS8SyQfYb-vM50x1NS-RzMWvVei103?usp=sharing"
w5d23_slides_url: "https://drive.google.com/file/d/1XGX6ulC48JtKbUO8MluBTmy3Dis9OOml/view?usp=drive_link"
w5d3_notebook_url: "https://colab.research.google.com/drive/1vRBoXZvkFsjxsSUHsQpbkUYNLQvDZ4Aa?usp=sharing"
    ...
    <div class="course-table-wrap">
      <table class="course-schedule">
        ...
        <tbody>
          ...
          <tr class="course-week-start"><td rowspan="3"><strong>2</strong><small>Language models</small></td><td>Mon., Aug. 31</td><td><strong>N-gram language models</strong></td><td class="course-materials-shared" rowspan="2">{% if page.w2d12_slides_url != "" %}<a class="course-tag course-tag--slides" href="{{ page.w2d12_slides_url }}" target="_blank" rel="noopener">W2D1–2</a>{% else %}<span class="course-tag course-tag--slides">W2D1–2</span>{% endif %} <a class="course-tag course-tag--reading" href="https://web.stanford.edu/~jurafsky/slp3/3.pdf" target="_blank" rel="noopener">SLP C3</a></td><td>—</td></tr>
          <tr><td>Wed., Sept. 2</td><td><strong>N-gram (cont) and LM evaluation</strong></td><td>—</td></tr>
          ...
          <tr class="course-week-start"><td rowspan="3"><strong>3</strong><small>Neural sequence models</small></td><td>Mon., Sept. 7</td><td><strong>Recurrent neural networks (RNNs)</strong></td><td class="course-materials-shared" rowspan="2">{% if page.w3d12_slides_url != "" %}<a class="course-tag course-tag--slides" href="{{ page.w3d12_slides_url }}" target="_blank" rel="noopener">W3D1–2</a>{% else %}<span class="course-tag course-tag--slides">W3D1–2</span>{% endif %} <a class="course-tag course-tag--reading" href="https://web.stanford.edu/~jurafsky/slp3/14.pdf" target="_blank" rel="noopener">SLP C14</a></td><td>—</td></tr>
          <tr><td>Wed., Sept. 9</td><td><strong>Long short-term memory networks (LSTMs)</strong></td><td>—</td></tr>
          ...
          <tr class="course-week-start"><td rowspan="3"><strong>5</strong><small>Representations and sequence-to-sequence models</small></td><td>Mon., Sept. 21</td><td><strong>Word embeddings</strong></td><td>{% if page.w5d1_slides_url != "" %}<a class="course-tag course-tag--slides" href="{{ page.w5d1_slides_url }}" target="_blank" rel="noopener">W5D1</a>{% else %}<span class="course-tag course-tag--slides">W5D1</span>{% endif %} {% if page.w5d1_notebook_url != "" %}<a class="course-tag course-tag--notebook" href="{{ page.w5d1_notebook_url }}" target="_blank" rel="noopener">W5D1 Demo</a>{% else %}<span class="course-tag course-tag--notebook">W5D1 Demo</span>{% endif %} <a class="course-tag course-tag--reading" href="https://web.stanford.edu/~jurafsky/slp3/5.pdf" target="_blank" rel="noopener">SLP C5</a></td><td>—</td></tr>
          <tr><td>Wed., Sept. 23</td><td><strong>Encoder–decoder models</strong></td><td class="course-materials-shared" rowspan="2">{% if page.w5d23_slides_url != "" %}<a class="course-tag course-tag--slides" href="{{ page.w5d23_slides_url }}" target="_blank" rel="noopener">W5D2–3</a>{% else %}<span class="course-tag course-tag--slides">W5D2–3</span>{% endif %} <a class="course-tag course-tag--reading" href="https://web.stanford.edu/~jurafsky/slp3/14.pdf" target="_blank" rel="noopener">SLP C14 (§§14.7–14.8)</a> {% if page.w5d3_notebook_url != "" %}<a class="course-tag course-tag--notebook" href="{{ page.w5d3_notebook_url }}" target="_blank" rel="noopener">W5D3 Activity</a>{% else %}<span class="course-tag course-tag--notebook">W5D3 Activity</span>{% endif %}</td><td>—</td></tr>
          <tr><td>Fri., Sept. 25</td><td><strong>Attention for sequence-to-sequence models</strong></td><td>—</td></tr>
          ...
          <tr><td>Fri., Oct. 2</td><td><strong>Machine translation: putting it all together</strong></td><td><a class="course-tag course-tag--reading" href="https://web.stanford.edu/~jurafsky/slp3/13.pdf" target="_blank" rel="noopener">SLP C13</a></td><td>{% if page.hw2_url != "" %}<a href="{{ page.hw2_url }}" target="_blank" rel="noopener"><strong>Homework 2</strong></a>{% else %}<strong>Homework 2</strong>{% endif %}<small>Due Oct. 2</small></td></tr>
          ...
          <tr class="course-week-start course-roadmap"><td>8</td><td>Oct. 12–16</td><td><strong>Mid-term project presentations</strong></td><td>—</td><td>{% if page.pm2_description_url != "" %}<a href="{{ page.pm2_description_url }}" target="_blank" rel="noopener"><strong>Baseline report &amp; presentation (PM2)</strong></a>{% else %}<strong>Baseline report &amp; presentation (PM2)</strong>{% endif %}</td></tr>
