    ...
    <div class="course-table-wrap">
      <table class="course-schedule">
        ...
        <tbody>
          ...
          <tr><td>Fri., Sept. 25</td><td><strong>Attention for sequence-to-sequence models</strong></td><td>{% if page.w5d3_notebook_url != "" %}<a class="course-tag course-tag--notebook" href="{{ page.w5d3_notebook_url }}" target="_blank" rel="noopener">W5D3 Activity</a>{% else %}<span class="course-tag course-tag--notebook">W5D3 Activity</span>{% endif %}</td><td>—</td></tr>
