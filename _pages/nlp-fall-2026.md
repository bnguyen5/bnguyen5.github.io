...
w4d1_slides_url: "https://drive.google.com/file/d/1x2PTiTvUF5bfef4FmJZ0XymPqTn90Zqd/view?usp=sharing"
    ...
    <div class="course-table-wrap">
      <table class="course-schedule">
        ...
        <tbody>
          ...
          <tr class="course-week-start"><td rowspan="3"><strong>4</strong><small>Syntax and parsing</small></td><td>Mon., Sept. 14</td><td><strong>Constituency parsing and CFGs</strong></td><td>{% if page.w4d1_slides_url != "" %}<a class="course-tag course-tag--slides" href="{{ page.w4d1_slides_url }}" target="_blank" rel="noopener">W4D1</a>{% else %}<span class="course-tag course-tag--slides">W4D1</span>{% endif %} <a class="course-tag course-tag--reading" href="https://web.stanford.edu/~jurafsky/slp3/19.pdf" target="_blank" rel="noopener">SLP C19</a></td><td>—</td></tr>
          <tr><td>Wed., Sept. 16</td><td><strong>CKY parsing</strong></td><td>—</td><td>—</td></tr>
