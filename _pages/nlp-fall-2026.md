...
w3d2_slides_url: "https://drive.google.com/file/d/1j2eZV5eJFz6K-WFNwp3T-61AIXzuuHcI/view?usp=sharing"
    ...
    <div class="course-table-wrap">
      <table class="course-schedule">
        ...
        <tbody>
          ...
          <tr class="course-week-start"><td rowspan="3"><strong>2</strong><small>Language models</small></td><td>Mon., Aug. 31</td><td><strong>N-gram language models</strong></td><td rowspan="2">{% if page.w2d12_slides_url != "" %}<a class="course-tag course-tag--slides" href="{{ page.w2d12_slides_url }}" target="_blank" rel="noopener">W2D1–2</a>{% else %}<span class="course-tag course-tag--slides">W2D1–2</span>{% endif %} <a class="course-tag course-tag--reading" href="https://web.stanford.edu/~jurafsky/slp3/3.pdf" target="_blank" rel="noopener">SLP C3</a></td><td>—</td></tr>
          ...
          <tr class="course-week-start"><td rowspan="3"><strong>3</strong><small>Neural sequence models</small></td><td>Mon., Sept. 7</td><td><strong>Recurrent neural networks (RNNs)</strong></td><td>{% if page.w3d1_slides_url != "" %}<a class="course-tag course-tag--slides" href="{{ page.w3d1_slides_url }}" target="_blank" rel="noopener">W3D1</a>{% else %}<span class="course-tag course-tag--slides">W3D1</span>{% endif %} <a class="course-tag course-tag--reading" href="https://web.stanford.edu/~jurafsky/slp3/14.pdf" target="_blank" rel="noopener">SLP C14 (before §14.5)</a></td><td>—</td></tr>
          <tr><td>Wed., Sept. 9</td><td><strong>Long short-term memory networks (LSTMs)</strong></td><td>{% if page.w3d2_slides_url != "" %}<a class="course-tag course-tag--slides" href="{{ page.w3d2_slides_url }}" target="_blank" rel="noopener">W3D2</a>{% else %}<span class="course-tag course-tag--slides">W3D2</span>{% endif %} <a class="course-tag course-tag--reading" href="https://web.stanford.edu/~jurafsky/slp3/14.pdf" target="_blank" rel="noopener">SLP C14 (§14.5 onward)</a></td><td>—</td></tr>
          ...
          <tr class="course-week-start"><td rowspan="3"><strong>4</strong><small>Syntax and parsing</small></td><td>Mon., Sept. 14</td><td><strong>Constituency parsing and CFGs</strong></td><td rowspan="2">{% if page.w4d12_slides_url != "" %}<a class="course-tag course-tag--slides" href="{{ page.w4d12_slides_url }}" target="_blank" rel="noopener">W4D1–2</a>{% else %}<span class="course-tag course-tag--slides">W4D1–2</span>{% endif %} <a class="course-tag course-tag--reading" href="https://web.stanford.edu/~jurafsky/slp3/19.pdf" target="_blank" rel="noopener">SLP C19</a></td><td>—</td></tr>
